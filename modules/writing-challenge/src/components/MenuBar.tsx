...
export function MenuBar({ profileName, currentPage, onNavigate, onProfileClick }: Props) {
    ...
    return (
      <nav className="menu-bar">
        ...
        <div className="menu-tabs">
          <button
            className={`menu-tab${currentPage === "admin" ? " active" : ""}`}
            onClick={() => onNavigate("admin")}
          >
            Users
          </button>
          <button
            className={`menu-tab${currentPage === "admin-system" ? " active" : ""}`}
  ...
  return (
    <nav className="menu-bar">
      ...
      <div className="menu-tabs">
        <button
          className={`menu-tab${currentPage === "practice" ? " active" : ""}`}
          onClick={() => onNavigate("practice")}
        >
          {t("menu.practice")}
        </button>
        <button
          className={`menu-tab${currentPage === "progress" ? " active" : ""}`}
          onClick={() => onNavigate("progress")}
        >
          {t("menu.progress")}
        </button>
        <button
          className={`menu-tab${currentPage === "settings" ? " active" : ""}`}
